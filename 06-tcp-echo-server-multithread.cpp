...
void HandleClient(int threadnum, SOCKET clientSocket) {
    ...
    do {
        ...
        std::cout << "> [Thread " << threadnum << "] received from client: " << buf << std::endl;
    ...
    threadNumber--;
    std::cout << "> [Thread " << threadnum << "] client disconnected" << std::endl;
...
void ServerThread() {
    ...
    while (!terminateServer) {
        ...
        if (FD_ISSET(serverSocket, &readSet)) {
            ...
            threadNumber++;
            std::cout << "> [Thread " << threadNumber << "] client connected" << std::endl;
